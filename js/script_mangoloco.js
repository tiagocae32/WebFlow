...
class FormManager {
  ...
  addPackageItemElements(packageItem, pkg) {
    ...
    let svgElementCalendar = createSvgElement(svgHTMLCalendar);
    packagePriceNameContainer.appendChild(svgElementCalendar);
    ...
    `;
    let svgElementCheckmark = createSvgElement(svgHTMLCheckmark);
    ...
    packageDescriptionList.id = "packageDescription";
